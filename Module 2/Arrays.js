...
console.log('First 3 Array Elements: ', case1) // [ 1, 2, 3 ]

// Case 2: Extract the last 3 array elements 
const case2 = arr.slice(-3)
console.log('Last 3 Array Elements: ', case2) // [ 8, 9, 10 ]

// Case 3: Extract elements from middle of array 
const case3 = arr.slice(3, 7)
console.log('Case 3: Extract elements from middle: ', case3) //  [ 4, 5, 6, 7 ]
